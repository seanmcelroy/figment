...
public class SpectreConsoleErrorProvider : IErrorProvider
{
    ...
    {
        AnsiConsole.MarkupLine($"[yellow]WARNING[/]: {formattableString}\r\n");
    }

    public void LogInfo(FormattableString formattableString)
    {
        AnsiConsole.MarkupLine($"[blue]INFO[/]: {formattableString}\r\n");
    }
    ...
    {
        AnsiConsole.MarkupInterpolated($"[yellow]WARNING[/]: {message}\r\n");
    }

    public void LogInfo(string message)
    {
        AnsiConsole.MarkupInterpolated($"[blue]INFO[/]: {message}\r\n");
    }
}