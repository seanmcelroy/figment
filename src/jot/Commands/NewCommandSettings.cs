...
{
    /// <summary>
    /// Gets the name of the <see cref="Figment.Common.Schema"/> for which to create a new entity.  If this schema does not exist, it will be created.
    /// </summary>
    ...
    /// <summary>
    /// Gets the name of the new <see cref="Figment.Common.Thing"/>.  If omitted, only a <see cref="Figment.Common.Schema"/> will be created but no thing of that schema's type.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether a <see cref="Figment.Common.Schema"/> should be created by default if one with a matching <see cref="SchemaName"/> does not exist.
    /// </summary>
