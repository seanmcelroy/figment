...
/// <summary>
/// The settings supplied to the <see cref="EditNoteCommand"/>.
/// </summary>
internal class EditNoteCommandSettings : CommandSettings
{
    /// <summary>
    /// Gets the task number to which to edit the note.
    /// </summary>
    [CommandArgument(0, "<TASK_ID>")]
    [Description("The task number to which to edit the note.")]
    public int TaskNumber { get; init; }

    /// <summary>
    /// Gets the note number which to edit.
    /// </summary>
    [CommandArgument(1, "<NOTE_ID>")]
    [Description("The note number which to edit.")]
